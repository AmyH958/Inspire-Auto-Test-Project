...
<WebElementEntity>
   ...
   <name>tr_CDATAfunction runScript(e)     if (e.key_630b8e</name>
   <tag></tag>
   <elementGuidId>2941ff2c-91d9-450b-86e2-95e5781ab6b4</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value>//form[@id='list_temp_searchForm']/table/tbody/tr</value>
      </entry>
      <entry>
         <key>CSS</key>
         <value>tr</value>
   ...
   <webElementProperties>
      ...
      <type>Main</type>
      <value>tr</value>
      <webElementGuid>e5c9f9e3-1dd0-43d4-968b-8c4c2635f312</webElementGuid>
   </webElementProperties>
   <webElementProperties>
...
館藏地名稱CMUL - 神資圖書館2 - 2123 - 123AH - 安南醫院AHGL - 安南圖書區av - avB007 - B007BCSB4 - BCSB4BX - 取書櫃1BY - 取書櫃2CB - 北港分館BAVN - 北港分館視聽區(限館內閱覽)BCIR - 北港分館流通櫃檯BCRA - 北港分館指參(限館內閱覽)BPAV - 北港分館視聽區BPCL - 北港分館書庫cbook - cbookcircd - circdclp - clpCM - 北港附設醫院BMHL - 北港附設醫院圖書室CMUL - 中國醫藥大學圖書館 - CMUL - 中國醫藥大學圖書館CU - 台中總館CUAV - 台中總館視聽區(獨立專區)MAVN - 台中總館視聽區(限館內閱覽)MAVR - 台中總館視聽區MCAT - 台中總館技服組MCBS - 台中總館密閉書庫MCIR - 台中總館流通櫃檯MCRA - 台中總館教師指定參考書(限館內閱覽)MCSS - 台中總館B3裝訂期刊區MDIA - 台中總館博碩士論文區MEAS - 台中總館探索史懷哲之路專書區MEXM - 台中總館國考書區(限館內閱覽)MFGA - 台中總館本校教職優良教材區MFPA - 台中總館本校教師升等資料區MFSA - 台中總館本校教職論著MHME - 台中總館人文專書區-醫學倫理(限館內閱覽)台中總館人文專書區-醫學倫理(限館內閱覽)MHMH - 台中總館人文專書區-醫療史(限館內閱覽)MHML - 台中總館人文專書區-醫學法律(限館內閱覽)MHQC - 台中總館人文專書區-醫療品質(限館內閱覽)MNBR - 台中總館新書展示區MPAA - 台中總館績效暨獲獎區(限館內閱覽)MPBL - 台中總館PBL專書區(限館內閱覽)MREF - 台中總館參考室MRSS - 台中總館閱覽組MS-C - 台中總館期刊複本櫃MSER - 台中總館期刊區MSPA - 台中總館研究計劃專書MSPB - 中醫醫史文獻室(限所內閱覽)MSPC - 台中總館特藏室MSTK - 台中總館書庫MYBK - 台中總館參考壁櫃new item 7 - new item 7ONLN - 台中總館線上資料e-resources - 電子資源EB-P - EB-Pelect - electH-EQ - H-EQH-MR - H-MRL - LL40 - L40LB 圖書總館 - LB 圖書總館LB-S - LB-SLE - 語文教學中心LEGL - 語文教學中心圖書室LIB - LIBnew item 1 - new item 1new item 3 - new item 3new item 2 - new item 2new item 4 - new item 4new item 5 - new item 5new item 6 - 英才校區new item 8 - new item 8NPTU - NPTUOUK - OUKPT - 培德醫院PTGL - 培德醫院圖書區ptext - ptextSB3 - SB3T-P - T-PTH - 台北分院THGL - 台北分院圖書區THPA - 台北分院期刊區W-P - W-PYH - 豐原分院YHGL - 豐原分院圖書區z3llc - z3llcz6bkf - z6bkfzd1a2 - zd1a2zd1e - zd1ezdlf - zdlf五樓漫畫書專區 - 五樓漫畫書專區實體館藏 - 實體館藏艾迪訊圖書館 - 艾迪訊圖書館龍華科技大學圖書館 - 龍華科技大學圖書館
...
window.dSelectTreeStructure.add(0,-1,'館藏地名稱'); 
...
window.dSelectTreeStructure.add(1123,1,&quot;new item 8 - new item 8&quot;, &quot;javascript:window.dSelectTreeStructure.selectElement('new item 8 - new item 8', 1123, true)&quot;); 
...
//]]>
      ...
      <webElementGuid>3301b45a-01e9-4c05-b920-c2e3adeab1dc</webElementGuid>
   </webElementProperties>
   <webElementProperties>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
      <name>xpath</name>
      <type>Main</type>
      <value>id(&quot;list_temp_searchForm&quot;)/table[@class=&quot;table1&quot;]/tbody[1]/tr[1]</value>
      <webElementGuid>3eea72d5-4773-41a3-b2d3-3a7492855982</webElementGuid>
   </webElementProperties>
   <webElementXpaths>
      <isSelected>true</isSelected>
      <matchCondition>equals</matchCondition>
      ...
      <type>Main</type>
      <value>//form[@id='list_temp_searchForm']/table/tbody/tr</value>
      <webElementGuid>b42d8510-061c-4a64-a413-9f2fcc6d83af</webElementGuid>
   </webElementXpaths>
   <webElementXpaths>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
      ...
      <type>Main</type>
      <value>(.//*[normalize-space(text()) and normalize-space(.)='待印明細維護'])[1]/following::tr[1]</value>
      <webElementGuid>1dca4d3d-5496-47af-93c7-b5e85a4a49a4</webElementGuid>
   </webElementXpaths>
   <webElementXpaths>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
      <name>xpath:neighbor</name>
      <type>Main</type>
      <value>(.//*[normalize-space(text()) and normalize-space(.)='待印清單維護'])[1]/following::tr[1]</value>
      <webElementGuid>f6521006-6758-4fd2-b607-c7ff85391061</webElementGuid>
   </webElementXpaths>
   <webElementXpaths>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
      ...
      <type>Main</type>
      <value>//tr</value>
      <webElementGuid>f92cb590-ef08-4efa-8fe6-ff7d824b29ec</webElementGuid>
   </webElementXpaths>
   <webElementXpaths>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
...
//]]>
			...
			&quot;))]</value>
      <webElementGuid>f633db0b-12f8-4613-b219-a765f527b3d8</webElementGuid>
   </webElementXpaths>
</WebElementEntity>
