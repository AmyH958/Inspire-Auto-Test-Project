...
<WebElementEntity>
   ...
   <tag></tag>
   <elementGuidId>47ae5abb-3be6-42ac-b7dc-fb5b023d04fa</elementGuidId>
   <selectorCollection>
      <entry>
         <key>CSS</key>
         <value>html</value>
   ...
   <webElementProperties>
      ...
      <type>Main</type>
      <value>html</value>
      <webElementGuid>42f6fdd7-3106-4489-b09e-6b65adc1a365</webElementGuid>
   </webElementProperties>
   <webElementProperties>
...
維護中
		...
		function openUpload(){
			...
			if(ie){ 
				...
				document.getElementById(&quot;selectImage&quot;).dispatchEvent(a); 
			}
		}
		...
		function previewImage(divImage, upload) {  
			try{
				...
				if(Browser_Agent.indexOf(&quot;Firefox&quot;)!=-1){
					...
					document.getElementById(divImage).innerHTML = &quot;&lt;img id='imgPreview' src='&quot;+imgPath+&quot;' style='padding:5px; width:300px; height:180px;' />&quot;;
				} else if(Browser_Agent.indexOf('Chrome') !== -1){
	                var reader = new FileReader();
					reader.readAsDataURL(upload.files[0]);
					reader.onload = function(e){                                      
						document.getElementById(divImage).innerHTML =&quot;&lt;img id='imgPreview' src='&quot;+e.target.result+&quot;' style='padding:5px; width:300px; height:180px;' />&quot;;
					};
				} else{
				...
				resetFile();
				var linkObject = document.getElementById(&quot;mess2&quot;);
				tapestry.form.submit(&quot;showDialogForm&quot;, &quot;mess2&quot;, {
					async : false,
					json  : false,
					cache : false,
					url : linkObject.href
		...
		function resetFile(){
			var html=document.getElementById(&quot;select&quot;).innerHTML;
...
dojo.require(&quot;tapestry.form&quot;);tapestry.form.registerForm(&quot;singleForm&quot;);
...
tapestry.form.registerForm(&quot;showDialogForm&quot;);
...
tapestry.form.focusField('PropertySelection');});
// -->
...
/html[1]window.FCKeditorAPI = {Version : &quot;2.6.3&quot;,VersionBuild : &quot;19836&quot;,Instances : new Object(),GetInstance : function( name ){return this.Instances[ name ];},_FormSubmit : function(){for ( var name in FCKeditorAPI.Instances ){var oEditor = FCKeditorAPI.Instances[ name ] ;if ( oEditor.GetParentForm &amp;&amp; oEditor.GetParentForm() == this )oEditor.UpdateLinkedField() ;}this._FCKOriginalSubmit() ;},_FunctionQueue	: {Functions : new Array(),IsRunning : false,Add : function( f ){this.Functions.push( f );if ( !this.IsRunning )this.StartNext();},StartNext : function(){var aQueue = this.Functions ;if ( aQueue.length > 0 ){this.IsRunning = true;aQueue[0].call();}else this.IsRunning = false;},Remove : function( f ){var aQueue = this.Functions;var i = 0, fFunc;while( (fFunc = aQueue[ i ]) ){if ( fFunc == f )aQueue.splice( i,1 );i++ ;}this.StartNext();}}}</value>
      <webElementGuid>b4c08b39-bfb1-48ba-9fb8-995cf3a875e3</webElementGuid>
   </webElementProperties>
   <webElementProperties>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
      ...
      <type>Main</type>
      <value>/html[1]</value>
      <webElementGuid>b9c491d9-8c6f-4161-a6eb-3c960a44b0a0</webElementGuid>
   </webElementProperties>
   <webElementXpaths>
      <isSelected>true</isSelected>
      <matchCondition>equals</matchCondition>
      ...
      <type>Main</type>
      <value>//html</value>
      <webElementGuid>8c7b1a92-24cc-4cdc-836c-b17c5a8ecb4a</webElementGuid>
   </webElementXpaths>
   <webElementXpaths>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
...
/html[1]window.FCKeditorAPI = {Version : &quot;2.6.3&quot;,VersionBuild : &quot;19836&quot;,Instances : new Object(),GetInstance : function( name ){return this.Instances[ name ];},_FormSubmit : function(){for ( var name in FCKeditorAPI.Instances ){var oEditor = FCKeditorAPI.Instances[ name ] ;if ( oEditor.GetParentForm &amp;&amp; oEditor.GetParentForm() == this )oEditor.UpdateLinkedField() ;}this._FCKOriginalSubmit() ;},_FunctionQueue	: {Functions : new Array(),IsRunning : false,Add : function( f ){this.Functions.push( f );if ( !this.IsRunning )this.StartNext();},StartNext : function(){var aQueue = this.Functions ;if ( aQueue.length > 0 ){this.IsRunning = true;aQueue[0].call();}else this.IsRunning = false;},Remove : function( f ){var aQueue = this.Functions;var i = 0, fFunc;while( (fFunc = aQueue[ i ]) ){if ( fFunc == f )aQueue.splice( i,1 );i++ ;}this.StartNext();}}}&quot;))]</value>
      <webElementGuid>eb453e80-48b7-47c1-9dfc-d66656884f09</webElementGuid>
   </webElementXpaths>
</WebElementEntity>
